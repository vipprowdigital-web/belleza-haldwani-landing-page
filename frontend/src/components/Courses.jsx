...
//   const getDesktopCourses = () => {
//     if (filteredCourses.length === 0) return [];

//     return Array.from({ length: Math.min(3, filteredCourses.length) }).map(
//       (_, index) => {
//         const courseIndex = (currentIndex + index) % filteredCourses.length;
//         return filteredCourses[courseIndex];
//       }
//     );
//   };
...
//     return (
//       <div className="group bg-light flex flex-col rounded-2xl overflow-hidden transition-all duration-500 hover:shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-secondary h-full w-full">
//         {/* Image Section */}
...
//   return (
//     <section className="w-full" id="courses bg-black">
...
//           Featured{" "}
//           <span className="text-secondary font-serif">Courses</span>
//         </h2>
...
//                   <button
//                     onClick={prevCourse}
//                     className="absolute left-1 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-primary text-light flex items-center justify-center shadow-lg z-10 hover:bg-secondary transition-all"
...
//                   <button
//                     onClick={nextCourse}
//                     className="absolute right-1 top-1/2 -translate-y-1/2 w-10 h-10 rounded-full bg-primary text-light flex items-center justify-center shadow-lg z-10 hover:bg-secondary transition-all"
...
//             {/* Desktop Course Slider - 3 Cards */}
//             <div className="hidden md:block w-full">
//               {filteredCourses.length > 0 ? (
//                 <div className="relative px-12">
//                   <div className="grid grid-cols-3 gap-7 lg:gap-10">
//                     {getDesktopCourses().map((course, index) => (
//                       <CourseCard
...
//                   <button
//                     onClick={prevCourse}
//                     className="absolute left-0 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-primary text-light flex items-center justify-center shadow-lg z-10 hover:bg-secondary transition-all"
//                     aria-label="Previous course"
//                   >
//                     <ChevronLeft size={24} />
//                   </button>
...
//                   <button
//                     onClick={nextCourse}
//                     className="absolute right-0 top-1/2 -translate-y-1/2 w-11 h-11 rounded-full bg-primary text-light flex items-center justify-center shadow-lg z-10 hover:bg-secondary transition-all"
//                     aria-label="Next course"
//                   >
